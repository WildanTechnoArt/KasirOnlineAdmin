...
import com.admin.kasironline.adapter.PagerAdapterTransaction
...
class TransactionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tabMenus = arrayOf(
            getString(R.string.tab_transaction_text_1),
            getString(R.string.tab_transaction_text_2)
        )

        val pageAdapter = PagerAdapterTransaction(this)
